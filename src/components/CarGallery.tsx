...
const CarGallery = React.forwardRef<HTMLDivElement, CarGalleryProps>(
  function CarGallery({ phone, images, videoThumbnail, id }, ref) {
    return (
      <section ref={ref} id={id} className="px-4 md:px-12 lg:px-20 py-10">
