  ...
  return (
    <div className="bg-white flex justify-center px-4 py-12">
      <div className="max-w-4xl text-gray-800 leading-relaxed">
        ...
        <p className="mb-4">
          Collector Car Depot stands apart from traditional providers. We
          provide the expertise and digital resources to connect your vehicle
          with the right buyers in a seamless, hassle-free manner. By
          facilitating clear communication and swift interactions between both
          parties, we help sellers maximize their vehicle's visibility and value
          with efficiency.
        </p>
