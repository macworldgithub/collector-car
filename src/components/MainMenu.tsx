  ...
  return (
    <footer className="bg-black text-white py-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-b border-gray-700 py-8">
        {/* Current Listings */}
        <div>
          <h3 className="font-extrabold text-lg tracking-wide mb-4 text-gray-200 uppercase">
            Current Listings
          </h3>
          <ul className="space-y-3">
            {footerLinks.currentListings.map((link, index) => (
              <li key={index}>
                <Link
                  href={link.href}
                  className="font-semibold text-gray-300 hover:text-white transition relative inline-block px-1
                  hover:shadow-[0_0_12px_rgba(255,255,255,0.6)] rounded-md"
                  onClick={onClose}
                >
                  {link.name}
                </Link>
        ...
        <div>
          ...
          <p className="flex items-center font-medium">
            <a
              href="tel:0493717475"
              className="flex items-center hover:text-white transition relative px-1 rounded-md
              hover:shadow-[0_0_12px_rgba(255,255,255,0.6)]"
            >
              <Phone className="h-4 w-4 mr-2" /> <span>0493717475</span>
            </a>
          </p>
          <p className="flex items-center mt-3 font-medium">
            <a
              href="mailto:admin@collectorcardepot.com"
              className="flex items-center hover:text-white transition relative px-1 rounded-md
              hover:shadow-[0_0_12px_rgba(255,255,255,0.6)]"
          ...
          <div className="flex space-x-5 mt-5">
            <a
              href="https://www.facebook.com/newcastle.carshowgarage"
              aria-label="Facebook"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full transition hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.8)]"
            >
              <FaFacebookF className="h-5 w-5" />
            </a>
            <a
              href="https://www.instagram.com/collectorcardepot_official/"
              aria-label="Instagram"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full transition hover:bg-white/10 hover:shadow-[0_0_15px_rgba(255,255,255,0.8)]"
      ...
      >
        <Image
          ...
          width={160}
          height={56}
          className="h-24 w-auto transition hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.9)]"
        />
      </div>
    </footer>
  );
